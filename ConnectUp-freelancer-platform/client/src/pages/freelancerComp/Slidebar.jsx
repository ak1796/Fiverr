...
const Slidebar = ({ user }) => {
  ...
  const headers = [
    { title: "Dashboard", icon: <MdSpaceDashboard />, link: "/freelancer" },
    {
      title: "Gigs",
      icon: <PiShoppingBagOpenBold />,
      link: "/freelancer/all-gigs",
    },
    {
      title: "Earnings",
    ...
    { title: "Messages", icon: <FaMessage />, link: "/freelancer/messages" },
    {
      title: "Profile",
      icon: <FaUser />,
      link: "/freelancer/freelancer-profile",
    },
  ];
  ...
  return (
    <div className="w-64 min-h-screen bg-white text-gray-800 flex flex-col p-4 shadow-md border-r">
      <div onClick={() => navigate("/")} className="mb-8">
        <h2 className="text-2xl font-bold text-black mb-1">Freelance Hub</h2>
